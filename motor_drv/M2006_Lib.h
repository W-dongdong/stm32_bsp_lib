/**
  ******************************************************************************
  * @file    M2006_Lib.h
  * @brief   M2006 Motor Driver Library - Header
  ******************************************************************************
  */

/*
 * File Name        : M2006_Lib.h
...
#ifndef __M2006_LIB_H
#define __M2006_LIB_H
...
private:
	...
	float	 m_redRatio;		// Reduction Ratio (default 36:1)
	...
	static M2006* MotorRegester[CANDevice::MAX_INSTANCES][MAX_MOTOR_PER_BUS];
